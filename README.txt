...
Download the source from Github: http://github.com/dfh/xsrf_guard/. Then
include it, something like so:
...
to protect. This is easiest done by using the method xsrf_guard_field():
